...
export default function ProjectDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!supabaseClient || !organization || Number.isNaN(projectIdNum)) {
      return;
    }
    ...
    async function loadData() {
      try {
        ...
        const [projectData, workflowData, objectData, fileData] = await Promise.all([
          projectService.getProjectById(supabaseClient, projectIdNum),
          workflowService.getWorkflowsByProject(supabaseClient, projectIdNum),
          objectService.getObjectsByProject(supabaseClient, projectIdNum),
          fileService.getFilesByProject(supabaseClient, projectIdNum),
        ]);
