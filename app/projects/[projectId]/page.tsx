    ...
    async function loadData() {
      try {
        ...
        const [projectData, workflowData, objectData, fileData] = await Promise.all([
          projectService.getProjectById(supabase, projectIdNum),
          workflowService.getWorkflowsByProject(supabase, projectIdNum),
          objectService.getObjectsByProject(supabase, projectIdNum),
          fileService.getFilesByProject(supabase, projectIdNum),
        ]);
