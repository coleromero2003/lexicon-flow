...
// This route uses dynamic params and should not be prerendered
// generateStaticParams is intentionally not exported (or returns empty array)
// to prevent build-time prerendering of client component pages
...
export default function WorkflowsClientPage() {
